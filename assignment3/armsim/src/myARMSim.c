...
void decode() {
  ...
  }else if(f==1){ Tcycles+=20; //LDR/STR
    ...
    { 
     if(s[1]==NULL){ 
      ...
      {  if(s[2]==NULL)
        ...
        }else{  if(s[3]!=NULL && s[4]!=NULL && s[3][0]=='[')
                { 
                  if ( s[5]!=NULL)
                  {error_count++;
                   printf("Error:only one instruction is allowed in one line. Error in line:%d\n",line_count );
                 }else  if ((s[3][1]=='r' || s[3][1]=='R') )
                    {   if((s[3][2]>=48 && s[3][2]<58 && strlen(s[3])==3) ||(s[3][2]==49 && strlen(s[3])==4 && s[3][3]>=48 && s[3][3]<52))
                      { int R1 ;if(strlen(s[3])==3) R1 = (int)s[3][2]-'0';
                            if(strlen(s[3])==4) R1=(s[3][2]-'0')*10 + s[3][3]-'0';
               ...
               len=strlen(s[3]);
                ...
                if(len<=5 && len>=3){int imm=0; for(int il=1;il<len-1;il++){
                  ...
                  if(imm>3999) printf("Error in line:%d is =>Immediate cann't be greater than 3999\n",line_count );
                    ...
                    write_word(MEM, address, (14<<28)|(1<<26)|(25<<20)|(13<<16)|(Rd<<12)|(imm));
                     address+=4;
                    //put instruction code here
                  }
                  }else{error_count++;
                  ...
                  for (int i = 2; i < strlen(s[3]); ++i)
                 {
                  ...
                  {error_count++;
                   printf("label not valid Error in line:%d\n",line_count);
                    ...
                    //instruction here
                    write_word(MEM,address, (14<<28)|(1<<26)|(25<<20)|(14<<16)|(Rd<<12)|(0)  );
                    address+=4;
                  }
      ...
      {  if(s[1]==NULL)
        {error_count++;
          printf("LDR instruction in line:%d is not complete\n",line_count );
        }else{  if(s[2]!=NULL && s[3]!=NULL && s[2][0]=='[')
                { 
                  if ( s[4]!=NULL)
                  {error_count++;
                   printf("Error:only one instruction is allowed in one line. Error in line:%d\n",line_count );
                 }else  if ((s[2][1]=='r' || s[2][1]=='R') )
                    {   if((s[2][2]>=48 && s[2][2]<58 && strlen(s[2])==3) ||(s[2][2]==49 && strlen(s[2])==4 && s[2][3]>=48 && s[2][3]<52))
                      { int R1 ;if(strlen(s[2])==3) R1 = (int)s[2][2]-'0';
                            if(strlen(s[2])==4) R1=(s[2][2]-'0')*10 + s[2][3]-'0';
